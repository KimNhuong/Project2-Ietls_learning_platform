...
namespace IeltsWeb.api.Migrations
{
    ...
    [Migration("20250515080049_AddQuestionAndAnswerOption")]
    partial class AddQuestionAndAnswerOption
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnswerOptionExamResult", b =>
                {
                    b.Property<int>("ExamResultsResultId")
                        .HasColumnType("int");

                    b.Property<int>("SelectedOptionsId")
                        .HasColumnType("int");

                    b.HasKey("ExamResultsResultId", "SelectedOptionsId");

                    b.HasIndex("SelectedOptionsId");

                    b.ToTable("ExamResultAnswerOptions", (string)null);
                });
            ...
            modelBuilder.Entity("IeltsWeb.api.models.AnswerOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AnswerOptionExamResult", b =>
                {
                    b.HasOne("IeltsWeb.api.models.ExamResult", null)
                        .WithMany()
                        .HasForeignKey("ExamResultsResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("IeltsWeb.api.models.AnswerOption", null)
                        .WithMany()
